...
object BlockEntityRegistration {
    ...
    val ENCHANTABLE_MECHANICAL_HARVESTER: BlockEntityEntry<EnchantableHarvesterBlockEntity> = REGISTRATE
        .blockEntity<EnchantableHarvesterBlockEntity>("enchantable_mechanical_harvester", ::EnchantableHarvesterBlockEntity)
    ...
    val ENCHANTABLE_MILLSTONE: BlockEntityEntry<EnchantableMillstoneBlockEntity> = REGISTRATE
        ...
        .visual(renderNormally = true) { SingleAxisRotatingVisual.of(AllPartialModels.MILLSTONE_COG) }
    ...
    val ENCHANTABLE_CRUSHING_WHEEL: BlockEntityEntry<EnchantableCrushingWheelBlockEntity> = REGISTRATE
        ...
        .visual(renderNormally = false) { SingleAxisRotatingVisual.of(AllPartialModels.CRUSHING_WHEEL) }
